...
public class ExpandJiraTicketComponentsITCase extends AbstractTableTestBase {
  ...
  public void setUp() {
    ...
    tEnv.createTemporaryFunction("ExpandJiraTicketComponents", ExpandJiraTicketComponents.class);
  }
  ...
  private List<Row> executeSql() throws Exception {
    TableResult resultTable =
        tEnv.executeSql(
            "SELECT component FROM input LEFT JOIN LATERAL TABLE(ExpandJiraTicketComponents(textBody)) AS T(component) ON TRUE");
  ...
  public void testWithString1() throws Exception {
    ...
    assertThat(rawResult, containsInAnyOrder(Row.ofKind(RowKind.INSERT, (Object) null)));
  }
  ...
  public void testWithString2() throws Exception {
    ...
    assertThat(rawResult, containsInAnyOrder(Row.ofKind(RowKind.INSERT, "Tests")));
  }
  ...
  public void testWithString3() throws Exception {
    ...
    assertThat(
        rawResult,
        containsInAnyOrder(
            Row.ofKind(RowKind.INSERT, "Tests"),
            Row.ofKind(RowKind.INSERT, "Formats (JSON, Avro, Parquet, ORC, SequenceFile)")));
  }
