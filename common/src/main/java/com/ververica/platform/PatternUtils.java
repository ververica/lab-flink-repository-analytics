...
public class PatternUtils {
   ...
   * when replying.
   */
  public static Pattern EMAIL_SUBJECT_THREAD_PATTERN =
   ...
   * format sent by Jira).
   */
  public static Pattern EMAIL_BODY_JIRA_TICKET_COMPONENTS_PATTERN =
   ...
   */
  public static Pattern EMAIL_BODY_JIRA_TICKET_COMPONENTS_SPLIT_PATTERN =
      Pattern.compile(", (?=(?:[^(]*\\([^)]*\\))*[^)]*$)");
}
